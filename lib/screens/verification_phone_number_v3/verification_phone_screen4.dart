...
class VerificationPhoneScreen4 extends StatelessWidget {
  const VerificationPhoneScreen4({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Row(
                  children: [
                    GestureDetector(
                      onTap: (){
                        Get.off(VerificationPhoneScreen3());
                      },
                ...
                ShowUpAnimation(
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Get.to(const VerificationPhoneScreen5());
                    },
                    child: const Text(
                      'Heading Your Way',
                      style: TextStyle(
