...
class VerificationPhoneScreen1 extends StatelessWidget {
  const VerificationPhoneScreen1({Key? key}) : super(key: key);
    ...
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: GestureDetector(
          onTap: (){
            Get.to(const VerificationPhoneScreen2());
          },
          child: Container(
            height:115,
              ...
              children: [
                ...
                ShowUpAnimation(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Image.asset('assets/images/moneyStamp.png'),
                    ),
                  ),
                ),
